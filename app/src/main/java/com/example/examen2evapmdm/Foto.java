...
public class Foto {
	...
	public static Drawable convertirBitMapADrawable(Bitmap bitmap, Context context)
	{
	 ...
	 static Bitmap convertirStringBitmap(String imagen) {
		if(imagen!=null)
		{
	...
	static Bitmap convertirRecursoBitmap(int recurso, Context context)
	{

		return  BitmapFactory.decodeResource(context.getResources(), recurso);
	}

	static String ConvertirImagenString(Bitmap bitmap) {
